...
from sklearn.preprocessing import OrdinalEncoder   ## ordinl encoder
## pipelines
from sklearn.pipeline import Pipeline
from sklearn.compose import ColumnTransformer    # to add two different pipeline
...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            return preprocessor
            logging.info('Pipeline Complected')
